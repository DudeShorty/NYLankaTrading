...
angular.module('RDash')
    .controller('ItemTankCtrl', ['$scope', 'ItemService', 'TankService', 'ItemTankService',
        'AlertService', '$cookieStore', '$location',
        function ($scope, ItemService, TankService, ItemTankService, AlertService, $cookieStore, $location) {
