...
angular.module("RDash").controller("BrandCtrl",["$scope","BrandService","AlertService",function(n,r,e){function c(){n.brandDTO={name:null,active:!0}}function o(){console.log("AddBrand"),r.insert(n.brandDTO).success(function(){a(),c(),e.addSuccessAlert("Brand Saved Successfully.")}).error(function(n){console.error(n)})}function a(){r.readAll().success(function(r){n.brands=r}).error(function(n){console.error(n)})}function d(n){r.deactivate(n).success(function(n){}).error(function(n){})}console.log("BrandCtrl"),n.refreshBrandDTO=c,c(),n.addBrand=o,n.readAll=a,n.deactivate=d,a()}]);
