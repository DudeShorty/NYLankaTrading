...
"use strict";angular.module("RDash").config(["$stateProvider","$urlRouterProvider",function(t,e){e.otherwise("/"),t.state("index",{url:"/",templateUrl:"templates/dashboard.html"}).state("tables",{url:"/tables",templateUrl:"templates/tables.html"}).state("item",{url:"/item",templateUrl:"templates/master/items.html"}).state("brand",{url:"/brand",templateUrl:"templates/master/brand.html"}).state("model",{url:"/model",templateUrl:"templates/master/model.html"})}]);
...
angular.module("RDash").controller("ItemCtrl",["$scope","ItemService",function(e,t){function n(){console.log("AddItem"),t.insert(e.itemDTO).success(function(){alert("Success")}).error(function(e){alert(JSON.stringify(e))})}console.log("ItemCtrl"),e.itemDTO={name:null},e.addItem=n}]);
