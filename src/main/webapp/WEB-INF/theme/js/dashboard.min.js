...
function MasterCtrl(t,e,n,a){function o(){t.authenticated=e.get("authenticated"),t.authenticated?(t.error=!1,t.authenticated=!0,e.put("authenticated",!0)):u(t.credentials,function(){t.authenticated?(a.path("/item-category"),t.error=!1):(a.path("/login"),t.error=!0)})}function i(){t.authenticated=!1,a.path("/login"),e.remove("authenticated")}var u=function(o,i){null!=o.username&&null!=o.password&&n.login(o).success(function(n){o.username==n.username?(t.authenticated=!0,e.put("authenticated",!0)):(a.path("/login"),t.authenticated=!1,e.put("authenticated",!1)),t.credentials={username:null,password:null},i&&i()}).error(function(n){a.path("/login"),t.authenticated=!1,e.put("authenticated",!1),i&&i()})};t.credentials={username:null,password:null},t.login=o,o(),t.logout=i;var r=992;t.getWidth=function(){return window.innerWidth},t.$watch(t.getWidth,function(n,a){n>=r?angular.isDefined(e.get("toggle"))?t.toggle=!!e.get("toggle"):t.toggle=!0:t.toggle=!1}),t.toggleSidebar=function(){t.toggle=!t.toggle,e.put("toggle",t.toggle)},window.onresize=function(){t.$apply()}}angular.module("RDash").controller("MasterCtrl",["$scope","$cookieStore","UserService","$location",MasterCtrl]);
...
angular.module("RDash").factory("UserService",["$http",function(n){var r="v1/user";return{insert:function(t){return n.post(r+"/add",t)},login:function(t){return n.post(r+"/login",t)}}}]);