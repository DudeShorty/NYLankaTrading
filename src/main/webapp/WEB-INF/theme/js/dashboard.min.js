...
"use strict";angular.module("RDash").config(["$stateProvider","$urlRouterProvider",function(t,e){e.otherwise("/"),t.state("index",{url:"/",templateUrl:"templates/dashboard.html"}).state("tables",{url:"/tables",templateUrl:"templates/tables.html"}).state("itemTank",{url:"/item-tank",templateUrl:"templates/ui/itemTank.html"}).state("tank",{url:"/tank",templateUrl:"templates/master/tank.html"}).state("item",{url:"/item",templateUrl:"templates/master/items.html"}).state("brand",{url:"/brand",templateUrl:"templates/master/brand.html"}).state("model",{url:"/model",templateUrl:"templates/master/model.html"})}]);
...
angular.module("RDash").controller("ItemCtrl",["$scope","ItemService","AlertService",function(e,t,n){function l(){e.itemDTO={name:null}}function c(){console.log("AddItem"),t.insert(e.itemDTO).success(function(){l(),n.addSuccessAlert("Item Saved Successfully.")}).error(function(e){alert(JSON.stringify(e))})}console.log("ItemCtrl"),e.itemDTO={name:null},e.refreshItemDTO=l,e.addItem=c}]);
...
angular.module("RDash").factory("AlertService",[function(){return{alerts:[],addSuccessAlert:function(e){this.alerts.push({type:"success",msg:e})},addFailedAlert:function(e){this.alerts.push({type:"danger",msg:e})},clearAlerts:function(){for(var e in this.alerts)delete this.alerts[e]}}}]);
...
angular.module("RDash").factory("ItemService",["$http",function(t){var n="v1/item";return{insert:function(r){return t.post(n+"/add",r)},search:function(){}}}]);