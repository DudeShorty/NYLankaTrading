...
function MasterCtrl(t,e,n,o){function a(){i(t.credentials,function(){t.authenticated?(o.path("/item-category"),t.error=!1):(o.path("/login"),t.error=!0)})}function l(){t.authenticated=!1,o.path("/login")}var i=function(e,n){"admin"==e.username&&"123"==e.password?t.authenticated=!0:(o.path("/login"),t.authenticated=!1),t.credentials={username:null,password:null},n&&n()};t.credentials={username:null,password:null},t.login=a,a(),t.logout=l;var r=992;t.getWidth=function(){return window.innerWidth},t.$watch(t.getWidth,function(n,o){n>=r?angular.isDefined(e.get("toggle"))?t.toggle=!!e.get("toggle"):t.toggle=!0:t.toggle=!1}),t.toggleSidebar=function(){t.toggle=!t.toggle,e.put("toggle",t.toggle)},window.onresize=function(){t.$apply()}}angular.module("RDash").controller("MasterCtrl",["$scope","$cookieStore","$http","$location",MasterCtrl]);
