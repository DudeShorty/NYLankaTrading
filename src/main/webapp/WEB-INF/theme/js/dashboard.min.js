...
"use strict";angular.module("RDash").config(["$stateProvider","$urlRouterProvider",function(t,e){e.otherwise("/"),t.state("index",{url:"/",templateUrl:"templates/dashboard.html"}).state("tables",{url:"/tables",templateUrl:"templates/tables.html"}).state("item",{url:"/item",templateUrl:"templates/master/items.html"}).state("brand",{url:"/brand",templateUrl:"templates/master/brand.html"})}]);
