...
angular.module("RDash").controller("ItemTankCtrl",["$scope","ItemService","TankService","ItemTankService","AlertService",function(e,n,c,o,t){function r(){e.itemTankDTO={tank_id:-1,item_id:-1,qty:0,unit_price:0}}function i(){n.readActive().success(function(n){e.items=n}).error(function(e){console.error(e)})}function s(){c.readActive().success(function(n){e.tanks=n}).error(function(e){console.error(e)})}function a(){console.log("addItemTank"),o.insert(e.itemTankDTO).success(function(){r(),i(),s(),t.addSuccessAlert("Item Successfully Added To Tank.")}).error(function(e){console.error(e)})}e.loadItemTankDTO=r,r(),e.loadItems=i,i(),e.loadTanks=s,s(),e.addItemTank=a}]);
...
angular.module("RDash").factory("ItemTankService",["$http",function(t){var n="v1/itemTank";return{insert:function(e){return t.post(n+"/add",e)},search:function(){},read:function(){return t.get(n+"/get")}}}]);
